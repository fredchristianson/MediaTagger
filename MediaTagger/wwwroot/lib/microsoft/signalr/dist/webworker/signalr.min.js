    ...
    return (() => {
      ...
      async function b(t, s, n, i, r, o, h) {
        ...
        (c[a] = l),
          t.log(
            e.Trace,
            `(${s} transport) sending data. ${y(o, h.logMessageContent)}.`
          );
      ...
      class N {
        constructor(t, s, n, i) {
          (this.C = 0),
            ...
            (this.j = !1),
            (this.M = this.k.writeMessage({ type: A.Ping }));
        }
      ...
      class F {
        ...
        Ht(t, e) {
          t.headers || (t.headers = {}),
            e
              ? (t.headers[j.Authorization] = `Bearer ${e}`)
              : t.headers[j.Authorization] && delete t.headers[j.Authorization];
        }
        async At(t, s) {
          try {
            for (; this.Tt; ) {
              ...
              try {
                ...
                204 === r.statusCode
                  ...
                  ? (this.u.log(
                      e.Trace,
                      `(LongPolling transport) data received. ${y(
                        r.content,
      ...
      class X {
        ...
        async connect(t, s) {
          ...
          return new Promise((n, i) => {
            ...
            if (g.isNode) {
              ...
              (e[s] = n),
                o && (e[j.Cookie] = `${o}`),
                (r = new this.qt(t, void 0, { headers: { ...e, ...this.jt } }));
            }
            r || (r = new this.qt(t)),
              s === W.Binary && (r.binaryType = 'arraybuffer'),
              (r.onopen = (s) => {
              ...
              (r.onmessage = (t) => {
                if (
                  (this.u.log(
                    e.Trace,
                    `(WebSockets transport) data received. ${y(
                      t.data,
                      this.Lt
                    )}.`
                  ),
        ...
        send(t) {
          return this.Mt && this.Mt.readyState === this.qt.OPEN
            ? (this.u.log(
                e.Trace,
                `(WebSockets transport) sending data. ${y(t, this.Lt)}.`
              ),
              this.Mt.send(t),
              Promise.resolve())
        ...
        Ut(t) {
          this.Mt &&
            ...
            this.onclose &&
              (!this.Wt(t) || (!1 !== t.wasClean && 1e3 === t.code)
                ? t instanceof Error
                  ? this.onclose(t)
                  : this.onclose()
                : this.onclose(
            ...
            if (h instanceof Error) o.push(`${n.transport} failed:`), o.push(h);
              ...
              try {
                ...
                if (
                  ...
                  (a = void 0),
                  o.push(new c(`${n.transport} failed: ${t}`, M[n.transport])),
                  'Connecting' !== this.q)
                ) {
                  const t =
        ...
        se(t, s, n) {
          ...
          if (
            ...
            return (
              this.u.log(
                e.Debug,
                `Skipping transport '${M[i]}' because it was disabled by the client.`
              ),
              new h(`'${M[i]}' is disabled by the client.`, i)
            );
          if (!(t.transferFormats.map((t) => W[t]).indexOf(n) >= 0))
            return (
              this.u.log(
                e.Debug,
                `Skipping transport '${M[i]}' because it does not support the requested transfer format '${W[n]}'.`
              ),
              new Error(`'${M[i]}' does not support ${W[n]}.`)
            );
          if (
            (i === M.WebSockets && !this.Pt.WebSocket) ||
            (i === M.ServerSentEvents && !this.Pt.EventSource)
          )
            return (
              this.u.log(
                e.Debug,
                `Skipping transport '${M[i]}' because it is not supported in your environment.'`
              ),
              new o(`'${M[i]}' is not supported in your environment.`, i)
            );
      ...
      class G {
        ...
        pe(t) {
          this.ye(t.target, 'Invalid payload for Invocation message.'),
        ...
        we(t) {
          if (
            (this.ye(t.invocationId, 'Invalid payload for StreamItem message.'),
            void 0 === t.item)
          )
        ...
        ge(t) {
          ...
          !t.result &&
            t.error &&
            this.ye(t.error, 'Invalid payload for Completion message.'),
            this.ye(t.invocationId, 'Invalid payload for Completion message.');
        }
        ye(t, e) {

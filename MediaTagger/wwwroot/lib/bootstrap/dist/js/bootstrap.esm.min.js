...
function bootstrapHandler(e, t) {
  return function i(n) {
    return (
      (n.delegateTarget = e),
      i.oneOff && EventListener.off(e, n.type, t),
      t.apply(e, [n])
    );
  };
}
    ...
    for (let { target: r } = s; r && r !== this; r = r.parentNode)
      for (let a = o.length; a--; )
        if (o[a] === r)
          return (
            (s.delegateTarget = r),
            n.oneOff && EventListener.off(e, s.type, t, i),
            i.apply(r, [s])
          );
    return null;
  };
...
const enableDismissTrigger = (e, t = 'hide') => {
    const i = 'click.dismiss' + e.EVENT_KEY,
      n = e.NAME;
    EventListener.on(document, i, `[data-bs-dismiss="${n}"]`, function (i) {
      if (
...
class Alert extends BaseComponent {
  ...
  close() {
    if (EventListener.trigger(this._element, EVENT_CLOSE).defaultPrevented)
      return;
...
class Carousel extends BaseComponent {
  ...
  to(e) {
    ...
    if (this._isSliding)
      return void EventListener.one(this._element, EVENT_SLID, () =>
        this.to(e)
      );
  ...
  _addEventListeners() {
    this._config.keyboard &&
      EventListener.on(this._element, EVENT_KEYDOWN, (e) => this._keydown(e)),
      'hover' === this._config.pause &&
        (EventListener.on(this._element, EVENT_MOUSEENTER, (e) =>
          this.pause(e)
        ),
        EventListener.on(this._element, EVENT_MOUSELEAVE, (e) =>
          this.cycle(e)
        )),
      this._config.touch &&
        this._touchSupported &&
  ...
  _addTouchEventListeners() {
    ...
    SelectorEngine.find(SELECTOR_ITEM_IMG, this._element).forEach((e) => {
      EventListener.on(e, EVENT_DRAG_START, (e) => e.preventDefault());
    }),
      this._pointerEvent
        ? (EventListener.on(this._element, EVENT_POINTERDOWN, (t) => e(t)),
          EventListener.on(this._element, EVENT_POINTERUP, (e) => i(e)),
          this._element.classList.add('pointer-event'))
        : (EventListener.on(this._element, EVENT_TOUCHSTART, (t) => e(t)),
          EventListener.on(this._element, EVENT_TOUCHMOVE, (e) => t(e)),
          EventListener.on(this._element, EVENT_TOUCHEND, (e) => i(e)));
  }
  _keydown(e) {
...
class Collapse extends BaseComponent {
  ...
  show() {
    ...
    if (EventListener.trigger(this._element, EVENT_SHOW$5).defaultPrevented)
      return;
    t.forEach((t) => {
  ...
  hide() {
    if (this._isTransitioning || !this._isShown()) return;
    if (EventListener.trigger(this._element, EVENT_HIDE$5).defaultPrevented)
      return;
...
class Dropdown extends BaseComponent {
  ...
  show() {
    ...
    if (EventListener.trigger(this._element, EVENT_SHOW$4, e).defaultPrevented)
      return;
    ...
    this._inNavbar
      ...
      'ontouchstart' in document.documentElement &&
        ...
        []
          ...
          .forEach((e) => EventListener.on(e, 'mouseover', noop)),
      this._element.focus(),
      this._element.setAttribute('aria-expanded', !0),
      this._menu.classList.add('show'),
      this._element.classList.add('show'),
      EventListener.trigger(this._element, EVENT_SHOWN$4, e);
  }
  hide() {
    if (isDisabled(this._element) || !this._isShown(this._menu)) return;
    const e = { relatedTarget: this._element };
  ...
  _completeHide(e) {
    EventListener.trigger(this._element, EVENT_HIDE$4, e).defaultPrevented ||
      ('ontouchstart' in document.documentElement &&
        []
          .concat(...document.body.children)
          .forEach((e) => EventListener.off(e, 'mouseover', noop)),
      this._popper && this._popper.destroy(),
      this._menu.classList.remove('show'),
      this._element.classList.remove('show'),
      this._element.setAttribute('aria-expanded', 'false'),
      Manipulator.removeDataAttribute(this._menu, 'popper'),
      EventListener.trigger(this._element, EVENT_HIDDEN$4, e));
  }
  _getConfig(e) {
    if (
      ((e = {
...
class FocusTrap {
  ...
  activate() {
    ...
    this._isActive ||
      ...
      EventListener.on(document, EVENT_FOCUSIN$1, (e) =>
        this._handleFocusin(e)
      ),
      EventListener.on(document, EVENT_KEYDOWN_TAB, (e) =>
  ...
  deactivate() {
    this._isActive &&
      ((this._isActive = !1), EventListener.off(document, EVENT_KEY$7));
  }
  _handleFocusin(e) {
    const { target: t } = e,
...
class Modal extends BaseComponent {
  ...
  show(e) {
    this._isShown ||
      ...
      EventListener.trigger(this._element, EVENT_SHOW$3, { relatedTarget: e })
        .defaultPrevented ||
      ((this._isShown = !0),
      ...
      EventListener.on(this._dialog, EVENT_MOUSEDOWN_DISMISS, () => {
        EventListener.one(this._element, EVENT_MOUSEUP_DISMISS, (e) => {
  ...
  hide() {
    ...
    if (EventListener.trigger(this._element, EVENT_HIDE$3).defaultPrevented)
      return;
    this._isShown = !1;
  ...
  dispose() {
    [window, this._dialog].forEach((e) => EventListener.off(e, '.bs.modal')),
  ...
  _setEscapeEvent() {
    this._isShown
      ? EventListener.on(this._element, EVENT_KEYDOWN_DISMISS$1, (e) => {
  ...
  _showBackdrop(e) {
    EventListener.on(this._element, EVENT_CLICK_DISMISS, (e) => {
  ...
  _triggerBackdropTransition() {
    if (
      EventListener.trigger(this._element, EVENT_HIDE_PREVENTED)
        .defaultPrevented
    )
      return;
...
EventListener.on(
  ...
  function (e) {
    ...
    ['A', 'AREA'].includes(this.tagName) && e.preventDefault(),
      EventListener.one(t, EVENT_SHOW$3, (e) => {
        e.defaultPrevented ||
          EventListener.one(t, EVENT_HIDDEN$3, () => {
...
class Offcanvas extends BaseComponent {
  ...
  show(e) {
    this._isShown ||
      EventListener.trigger(this._element, EVENT_SHOW$2, { relatedTarget: e })
        .defaultPrevented ||
      ((this._isShown = !0),
  ...
  hide() {
    this._isShown &&
      (EventListener.trigger(this._element, EVENT_HIDE$2).defaultPrevented ||
        (this._focustrap.deactivate(),
        this._element.blur(),
        (this._isShown = !1),
        this._element.classList.remove('show'),
  ...
  _addEventListeners() {
    EventListener.on(this._element, EVENT_KEYDOWN_DISMISS, (e) => {
...
EventListener.on(
  ...
  function (e) {
    ...
    if (
      ...
      return;
    EventListener.one(t, EVENT_HIDDEN$2, () => {
      isVisible(this) && this.focus();
    });
...
class Tooltip extends BaseComponent {
  ...
  show() {
    ...
    const e = EventListener.trigger(this._element, this.constructor.Event.SHOW),
    ...
    l && n.classList.add(...l.split(' ')),
      'ontouchstart' in document.documentElement &&
        [].concat(...document.body.children).forEach((e) => {
          EventListener.on(e, 'mouseover', noop);
        });
  ...
  hide() {
    ...
    if (
      EventListener.trigger(this._element, this.constructor.Event.HIDE)
        .defaultPrevented
    )
      return;
  ...
  _setListeners() {
    this._config.trigger.split(' ').forEach((e) => {
      if ('click' === e)
        ...
        EventListener.on(this._element, t, this._config.selector, (e) =>
          this._enter(e)
        ),
          EventListener.on(this._element, i, this._config.selector, (e) =>
            this._leave(e)
          );
      }
    }),
...
class ScrollSpy extends BaseComponent {
  ...
  dispose() {
    EventListener.off(this._scrollElement, EVENT_KEY$2), super.dispose();
  }
  _getConfig(e) {
    return (
      ((e = {
...
class Tab extends BaseComponent {
  ...
  show() {
    ...
    const n = e
      ? EventListener.trigger(e, EVENT_HIDE$1, { relatedTarget: this._element })
      : null;
    if (
      EventListener.trigger(this._element, EVENT_SHOW$1, { relatedTarget: e })
        .defaultPrevented ||
    ...
    const s = () => {
      EventListener.trigger(e, EVENT_HIDDEN$1, {
...
class Toast extends BaseComponent {
  ...
  show() {
    EventListener.trigger(this._element, EVENT_SHOW).defaultPrevented ||
      (this._clearTimeout(),
  ...
  hide() {
    this._element.classList.contains('show') &&
      (EventListener.trigger(this._element, EVENT_HIDE).defaultPrevented ||
        (this._element.classList.add('showing'),
        this._queueCallback(
          () => {
  ...
  _setListeners() {
    EventListener.on(this._element, EVENT_MOUSEOVER, (e) =>
      this._onInteraction(e, !0)
    ),
      EventListener.on(this._element, EVENT_MOUSEOUT, (e) =>
        this._onInteraction(e, !1)
      ),
      EventListener.on(this._element, EVENT_FOCUSIN, (e) =>
        this._onInteraction(e, !0)
      ),
      EventListener.on(this._element, EVENT_FOCUSOUT, (e) =>
        this._onInteraction(e, !1)
      );
  }
  _clearTimeout() {

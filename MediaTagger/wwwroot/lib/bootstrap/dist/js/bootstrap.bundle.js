...
(function (global, factory) {
  ...
  function bootstrapHandler(element, fn) {
    return function handler(event) {
      ...
      if (handler.oneOff) {
        EventListener.off(element, event.type, fn);
      }
        ...
        for (let i = domElements.length; i--; ) {
          if (domElements[i] === target) {
            ...
            if (handler.oneOff) {
              ...
              EventListener.off(element, event.type, selector, fn);
            }
  ...
  class BaseComponent {
    ...
    dispose() {
      ...
      EventListener.off(this._element, this.constructor.EVENT_KEY);
  ...
  class Alert extends BaseComponent {
    ...
    close() {
      const closeEvent = EventListener.trigger(this._element, EVENT_CLOSE);
    ...
    _destroyElement() {
      ...
      EventListener.trigger(this._element, EVENT_CLOSED);
      this.dispose();
    } // Static
  ...
  class Carousel extends BaseComponent {
    ...
    to(index) {
      ...
      if (this._isSliding) {
        EventListener.one(this._element, EVENT_SLID, () => this.to(index));
        return;
      }
    ...
    _addEventListeners() {
      if (this._config.keyboard) {
        EventListener.on(this._element, EVENT_KEYDOWN, (event) =>
          this._keydown(event)
        );
      }

      if (this._config.pause === 'hover') {
        EventListener.on(this._element, EVENT_MOUSEENTER, (event) =>
          this.pause(event)
        );
        EventListener.on(this._element, EVENT_MOUSELEAVE, (event) =>
          this.cycle(event)
        );
      }
    ...
    _addTouchEventListeners() {
      ...
      SelectorEngine.find(SELECTOR_ITEM_IMG, this._element).forEach(
        (itemImg) => {
          EventListener.on(itemImg, EVENT_DRAG_START, (e) =>
            e.preventDefault()
          );
        }
      );
      ...
      if (this._pointerEvent) {
        EventListener.on(this._element, EVENT_POINTERDOWN, (event) =>
          start(event)
        );
        EventListener.on(this._element, EVENT_POINTERUP, (event) => end(event));

        this._element.classList.add(CLASS_NAME_POINTER_EVENT);
      } else {
        EventListener.on(this._element, EVENT_TOUCHSTART, (event) =>
          start(event)
        );
        EventListener.on(this._element, EVENT_TOUCHMOVE, (event) =>
          move(event)
        );
        EventListener.on(this._element, EVENT_TOUCHEND, (event) => end(event));
      }
    }
    ...
    _triggerSlideEvent(relatedTarget, eventDirectionName) {
      ...
      return EventListener.trigger(this._element, EVENT_SLIDE, {
        relatedTarget,
    ...
    _slide(directionOrOrder, element) {
      ...
      const triggerSlidEvent = () => {
        EventListener.trigger(this._element, EVENT_SLID, {
  ...
  EventListener.on(window, EVENT_LOAD_DATA_API$2, () => {
  ...
  class Collapse extends BaseComponent {
    ...
    show() {
      ...
      const startEvent = EventListener.trigger(this._element, EVENT_SHOW$5);
      ...
      const complete = () => {
        ...
        EventListener.trigger(this._element, EVENT_SHOWN$5);
      };
    ...
    hide() {
      ...
      const startEvent = EventListener.trigger(this._element, EVENT_HIDE$5);
      ...
      const complete = () => {
        ...
        EventListener.trigger(this._element, EVENT_HIDDEN$5);
      };
  ...
  let variationPlacements = /*#__PURE__*/ basePlacements.reduce(function (
    acc,
    placement
  ) {
  ...
  function effect$2(_ref2) {
    ...
    return function () {
      Object.keys(state.elements).forEach(function (name) {
        ...
        let attributes = state.attributes[name] || {};
        let styleProperties = Object.keys(
  ...
  */
  ...
  function detectOverflow(state, options) {
    ...
    let paddingObject = mergePaddingObject(
      typeof padding !== 'number'
        ? padding
        : expandToHashMap(padding, basePlacements)
    );
    ...
    let clippingClientRect = getClippingRect(
      isElement(element)
        ? element
    ...
    let popperClientRect = rectToClientRect(
  ...
  function flip(_ref) {
    ...
    let placements = [preferredPlacement]
  ...
  function hide(_ref) {
    ...
    let referenceClippingOffsets = getSideOffsets(
      referenceOverflow,
      referenceRect
    );
    let popperEscapeOffsets = getSideOffsets(
      popperAltOverflow,
      popperRect,
      preventedOffsets
    );
  ...
  function preventOverflow(_ref) {
    ...
    if (checkMainAxis || checkAltAxis) {
      ...
      let arrowPaddingObject = state.modifiersData['arrow#persistent']
      ...
      let arrowOffsetParent =
        state.elements.arrow && getOffsetParent(state.elements.arrow);
      let clientOffset = arrowOffsetParent
        ? mainAxis === 'y'
          ? arrowOffsetParent.clientTop || 0
          : arrowOffsetParent.clientLeft || 0
        : 0;
      let offsetModifierValue = state.modifiersData.offset
    ...
    return function createPopper(reference, popper, options) {
      ...
      let instance = {
        ...
        setOptions: function setOptions(options) {
          ...
          let orderedModifiers = orderModifiers(
  ...
  class Dropdown extends BaseComponent {
    ...
    show() {
      ...
      const showEvent = EventListener.trigger(
        this._element,
        EVENT_SHOW$4,
        relatedTarget
      );
      ...
      if (
        ...
        []
          ...
          .forEach((elem) => EventListener.on(elem, 'mouseover', noop));
      }
      ...
      EventListener.trigger(this._element, EVENT_SHOWN$4, relatedTarget);
    }
    ...
    _completeHide(relatedTarget) {
      const hideEvent = EventListener.trigger(
        this._element,
        EVENT_HIDE$4,
        relatedTarget
      );
      ...
      if ('ontouchstart' in document.documentElement) {
        []
          .concat(...document.body.children)
          .forEach((elem) => EventListener.off(elem, 'mouseover', noop));
      }
      ...
      EventListener.trigger(this._element, EVENT_HIDDEN$4, relatedTarget);
    }
  ...
  EventListener.on(document, EVENT_CLICK_DATA_API$3, Dropdown.clearMenus);
  EventListener.on(document, EVENT_KEYUP_DATA_API, Dropdown.clearMenus);
  EventListener.on(
    document,
  ...
  class Backdrop {
    ...
    _append() {
      ...
      EventListener.on(this._getElement(), EVENT_MOUSEDOWN, () => {
    ...
    dispose() {
      ...
      EventListener.off(this._element, EVENT_MOUSEDOWN);
  ...
  class FocusTrap {
    ...
    activate() {
      ...
      EventListener.off(document, EVENT_KEY$7); // guard against infinite focus loop

      EventListener.on(document, EVENT_FOCUSIN$1, (event) =>
        this._handleFocusin(event)
      );
      EventListener.on(document, EVENT_KEYDOWN_TAB, (event) =>
    ...
    deactivate() {
      ...
      this._isActive = false;
      EventListener.off(document, EVENT_KEY$7);
    } // Private
  ...
  class Modal extends BaseComponent {
    ...
    show(relatedTarget) {
      ...
      const showEvent = EventListener.trigger(this._element, EVENT_SHOW$3, {
        relatedTarget
      });
      ...
      EventListener.on(this._dialog, EVENT_MOUSEDOWN_DISMISS, () => {
        EventListener.one(this._element, EVENT_MOUSEUP_DISMISS, (event) => {
    ...
    hide() {
      ...
      const hideEvent = EventListener.trigger(this._element, EVENT_HIDE$3);
      ...
      EventListener.off(this._element, EVENT_CLICK_DISMISS);
      EventListener.off(this._dialog, EVENT_MOUSEDOWN_DISMISS);
    ...
    dispose() {
      [window, this._dialog].forEach((htmlElement) =>
        EventListener.off(htmlElement, EVENT_KEY$6)
      );
    ...
    _showElement(relatedTarget) {
      ...
      const transitionComplete = () => {
        ...
        this._isTransitioning = false;
        EventListener.trigger(this._element, EVENT_SHOWN$3, {
          relatedTarget
        });
      };
    ...
    _setEscapeEvent() {
      if (this._isShown) {
        EventListener.on(this._element, EVENT_KEYDOWN_DISMISS$1, (event) => {
        ...
        EventListener.off(this._element, EVENT_KEYDOWN_DISMISS$1);
      }
    }

    _setResizeEvent() {
      if (this._isShown) {
        EventListener.on(window, EVENT_RESIZE, () => this._adjustDialog());
      } else {
        EventListener.off(window, EVENT_RESIZE);
      }
    }
    ...
    _hideModal() {
      ...
      this._backdrop.hide(() => {
        ...
        EventListener.trigger(this._element, EVENT_HIDDEN$3);
      });
    }

    _showBackdrop(callback) {
      EventListener.on(this._element, EVENT_CLICK_DISMISS, (event) => {
  ...
  EventListener.on(
    ...
    function (event) {
      ...
      EventListener.one(target, EVENT_SHOW$3, (showEvent) => {
        if (showEvent.defaultPrevented) {
          // only register focus restorer if modal will actually get shown
          return;
        }

        EventListener.one(target, EVENT_HIDDEN$3, () => {
          if (isVisible(this)) {
            this.focus();
          }
        });
  ...
  class Offcanvas extends BaseComponent {
    ...
    show(relatedTarget) {
      ...
      const showEvent = EventListener.trigger(this._element, EVENT_SHOW$2, {
        relatedTarget
      });
      ...
      const completeCallBack = () => {
        ...
        EventListener.trigger(this._element, EVENT_SHOWN$2, {
          relatedTarget
        });
      };
    ...
    hide() {
      ...
      const hideEvent = EventListener.trigger(this._element, EVENT_HIDE$2);
      ...
      const completeCallback = () => {
        ...
        EventListener.trigger(this._element, EVENT_HIDDEN$2);
      };
    ...
    _addEventListeners() {
      EventListener.on(this._element, EVENT_KEYDOWN_DISMISS, (event) => {
  ...
  EventListener.on(
    ...
    function (event) {
      ...
      EventListener.one(target, EVENT_HIDDEN$2, () => {
  ...
  EventListener.on(window, EVENT_LOAD_DATA_API$1, () =>
  ...
  class Tooltip extends BaseComponent {
    ...
    show() {
      ...
      if (!this._element.ownerDocument.documentElement.contains(this.tip)) {
        ...
        EventListener.trigger(this._element, this.constructor.Event.INSERTED);
      }
      ...
      if ('ontouchstart' in document.documentElement) {
        [].concat(...document.body.children).forEach((element) => {
          EventListener.on(element, 'mouseover', noop);
        });
      }
      ...
      const complete = () => {
        ...
        EventListener.trigger(this._element, this.constructor.Event.SHOWN);
    ...
    hide() {
      ...
      const complete = () => {
        ...
        EventListener.trigger(this._element, this.constructor.Event.HIDDEN);
      ...
      if ('ontouchstart' in document.documentElement) {
        []
          .concat(...document.body.children)
          .forEach((element) => EventListener.off(element, 'mouseover', noop));
      }
  ...
  class ScrollSpy extends BaseComponent {
    constructor(element, config) {
      ...
      EventListener.on(this._scrollElement, EVENT_SCROLL, () =>
        this._process()
      );
      this.refresh();
    ...
    dispose() {
      EventListener.off(this._scrollElement, EVENT_KEY$2);
      super.dispose();
    } // Private
    ...
    _activate(target) {
      ...
      EventListener.trigger(this._scrollElement, EVENT_ACTIVATE, {
  ...
  EventListener.on(window, EVENT_LOAD_DATA_API, () => {
  ...
  class Tab extends BaseComponent {
    ...
    show() {
      ...
      const hideEvent = previous
        ? EventListener.trigger(previous, EVENT_HIDE$1, {
            relatedTarget: this._element
          })
        : null;
      const showEvent = EventListener.trigger(this._element, EVENT_SHOW$1, {
      ...
      const complete = () => {
        EventListener.trigger(previous, EVENT_HIDDEN$1, {
          relatedTarget: this._element
        });
        EventListener.trigger(this._element, EVENT_SHOWN$1, {
          relatedTarget: previous
        });
      };
  ...
  class Toast extends BaseComponent {
    ...
    show() {
      const showEvent = EventListener.trigger(this._element, EVENT_SHOW);
      ...
      const complete = () => {
        ...
        EventListener.trigger(this._element, EVENT_SHOWN);
    ...
    hide() {
      ...
      const hideEvent = EventListener.trigger(this._element, EVENT_HIDE);
      ...
      const complete = () => {
        ...
        EventListener.trigger(this._element, EVENT_HIDDEN);
      };
    ...
    _setListeners() {
      EventListener.on(this._element, EVENT_MOUSEOVER, (event) =>
        this._onInteraction(event, true)
      );
      EventListener.on(this._element, EVENT_MOUSEOUT, (event) =>
        this._onInteraction(event, false)
      );
      EventListener.on(this._element, EVENT_FOCUSIN, (event) =>
        this._onInteraction(event, true)
      );
      EventListener.on(this._element, EVENT_FOCUSOUT, (event) =>
        this._onInteraction(event, false)
      );
    }

...
import { BuildCustomEventHandler, Listeners, BuildClickHandler, Continuation } from '../../drjs/browser/event.js';
import { media, FocusChangeEvent, FocusEntityChangeEvent } from '../modules/media.js';
...
class FocusView extends Control {
    constructor(component, root) {
        ...
        this.root = component.dom.first(root);
    ...
    onFileChange() {
        log.always('focus-view onVisibleItemChange');
